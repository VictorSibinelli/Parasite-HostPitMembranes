...
#####No difference found between edges and center thickness
...
pit_mean_diff <- data.frame(Species1 = character(),
                            SP1mean = numeric(),
                            Species2 = character(),
                            SP2mean = numeric(),
...
pit_mean_diff <- rbind(pit_mean_diff, data.frame(Species1 = "Psittacanthus robustus", SP1mean = mean_diff1[1], Species2 = "Vochysia thyrsoidea", SP2mean = mean_diff1[2], MeanDifference = mean_diff1[3]))
pit_mean_diff <- rbind(pit_mean_diff, data.frame(Species1 = "Phoradendron", SP1mean = mean_diff2[1], Species2 = "Tapirira", SP2mean = mean_diff2[2], MeanDifference = mean_diff2[3]))
pit_mean_diff <- rbind(pit_mean_diff, data.frame(Species1 = "Struthanthus", SP1mean = mean_diff3[1], Species2 = "Tipuana", SP2mean = mean_diff3[2], MeanDifference = mean_diff3[3]))
